...
enum SerenaError: LocalizedError, Equatable {
    ...
    // SerenaTools integration errors
    ...
    var errorDescription: String? {
        ...
        case .serenaToolsNotAvailable:
            return "SerenaTools integration is not available in this version."
        case .serenaToolsNotConnected:
            return "Not connected to SerenaTools. Please establish a connection first."
        case .serenaToolsExecutionFailed(let message):
            return "SerenaTools command execution failed: \(message)"
        }
    }
    ...
    var recoverySuggestion: String? {
        ...
        case .serenaToolsNotAvailable:
            return "SerenaTools integration will be available in future versions. Current functionality works without it."
        case .serenaToolsNotConnected:
            return "Try connecting to SerenaTools using the connection settings."
        case .serenaToolsExecutionFailed:
    ...
    var isRecoverable: Bool {
        ...
        case .aiModelNotFound, .aiModelInitializationFailed, .databaseError, .configurationError:
            return false
        case .aiResponseGenerationFailed, .aiProcessingError, .voiceRecognitionFailed, .invalidFTAIFormat, .unknownError, .serenaToolsNotConnected, .serenaToolsExecutionFailed:
            return true
        case .serenaToolsNotAvailable:
            return false
        }
    ...
    var severity: ErrorSeverity {
        ...
        case .serenaToolsNotAvailable:
            return .info
        case .serenaToolsNotConnected, .serenaToolsExecutionFailed:
            return .warning
        }
    }
}
