...
struct FTAIDocument: Codable, Equatable {
    let version: String
    ...
    init(version: String, metadata: [String: String] = [:], content: String, schema: FTAISchema? = nil) {
...
struct FTAISchema: Codable, Equatable {
    let name: String
    let version: String
...
struct FTAIField: Codable, Equatable {
    let name: String
...
enum FTAIFieldType: String, Codable, CaseIterable {
    case string
    case integer
    case boolean
    case array
