...
class ErrorManager: ObservableObject {
    ...
    func getRecoveryAction(for error: SerenaError) -> ErrorRecoveryAction {
        ...
        case .serenaToolsNotAvailable:
            return .ignore("SerenaTools will be available in future versions")
        case .serenaToolsNotConnected:
            return .retry("Try connecting to SerenaTools")
        case .serenaToolsExecutionFailed:
            return .retry("Check command parameters and try again")
        }
    }
